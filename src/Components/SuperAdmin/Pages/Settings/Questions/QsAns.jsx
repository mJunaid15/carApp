...
export const QsAns = (props) => {
  ...
  const handleCreateQuestion = () => {
   ...
   const handleEditQuestion = () => {
    ...
    http.post(`/question/${editItem.id}`, formData)
    .then((res) => {
      setOpen(false);
      fetchQuestions();
    }).catch(err => console.log(err.message))
    ...
    <>
    {
        ...
        { qsList?.map( (data, index) => {
          return (
            <div key={index}>
              ...
              <p> <strong> Qs.{index + 1}  {data.question}</strong> </p>
      ...
      >
        <DialogContent style={{ width: '800px', backgroundColor: "white"}}>
          ...
          { editCheck ?  <h1 className="text-2xl text-center"> Edit This Question</h1> :
            <h1 className="text-2xl text-center"> Create Your Question</h1> }
          </div>
      ...
      >
        <DialogContent>
          ...
          <div className="bg-white p-4 mt-4">
            <h1 className="text-2xl">Are You Sure To Delete This Question?</h1>
          </div>
          <div className="flex justify-center">
            <Button
              autoFocus
