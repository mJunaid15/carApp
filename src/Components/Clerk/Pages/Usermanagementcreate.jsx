...
export const Usermanagementcreate = () => {
  ...
  return (
    <>
        ...
        {
            companyCheck  ? <Usermanagment /> : <div >
...
<div className='row mt-5'>
    ...
    <div className='col-lg-6'>
        ...
        <div className='company'>
            ...
            <p style={{ fontWeight: "bold", fontSize: "12px" }}> Solution</p>
...
<div className='row mt-5'>
    ...
    <div className='col-lg-6 mt-5'>
        ...
        <div className='Tax'>
            ...
            <TextField fullWidth label="Enter your company" id="0317258963" />
...
<div className='row mt-5'>
    ...
    <div className='col-lg-6'>
        ...
        <div className='Mail'>
            ...
            <TextField fullWidth label="Enter your mail box" id="Enter your mail box" />
